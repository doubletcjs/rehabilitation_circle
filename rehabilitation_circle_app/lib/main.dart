...
import 'package:sam_utils_library/sam_utils_library.dart';

void main() {
  Get.deleteAll();

  UtilsLibrary.instance().then((value) {
    // Hide statebar and system bottombar
    SystemChrome.setEnabledSystemUIMode(SystemUiMode.immersiveSticky, overlays: []);
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(statusBarColor: Colors.transparent));
    // Lock screen orientation main() WidgetsFlutterBinding.ensureInitialized();
    SystemChrome.setPreferredOrientations(const [DeviceOrientation.portraitUp]);

    runApp(const LifecycleApp(child: MyApp()));
  });
}
